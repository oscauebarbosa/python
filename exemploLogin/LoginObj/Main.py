...
def Cadastrar():
    ...
    if Login and Nome and CPF and Genero!= "Selecione" and Data and Senha:
        ...
        Lb_Cad_Erro.configure(text="Confira os campos MAFI!!")
...
def Autenticar():
    ...
    match Resultado:
        ...
        case "Vazia":
            Lb_Erro.configure(text="Sem nenhum Cadastro!")
...
#Confirmar Senha
Lb_Cad_ConfSenha = CriarLabel(Abas.tab("Cadastro")," Confirmar senha: ",6,5)
