...
Email_Tela1 = CriarCaixaDeTexto(Tela1, 200, 30, 4, 6, 'Insira seu e-mail')

LbSenha_Tela1 = CriarLabel(Tela1, "Senha:", 5, 6)
LbSenha_Tela1.configure(text_color="White", font=("arial", 15, "bold"))
Senha_Tela1 = CriarCaixaDeTexto(Tela1, 200, 30, 6, 6, 'Insira sua senha',Modo="Senha")
...
Btn_Tela1 = CriarBotão(Tela1, "Logar", Login, 10, 6, 100, 30)
Btn_Tela1.configure(fg_color="Blue", hover_color="Purple")

Btn_Tela1 = CriarBotão(Tela1, "Cadastrar-se", Clicar, 11, 6, 100, 30)
Btn_Tela1.configure(fg_color="Blue", hover_color="Purple")
...
Email_Tela2 = CriarCaixaDeTexto(Tela2, 200, 30, 3, 5, 'Insira seu nome')

LbEmail_Tela2 = CriarLabel(Tela2, "E-mail:", 5, 4)
LbEmail_Tela2.configure(text_color="White", font=("arial", 15, "bold"))
Email_Tela2 = CriarCaixaDeTexto(Tela2, 200, 30, 5, 5, 'Insira seu e-mail', Modo="")

LbEmail_Tela2 = CriarLabel(Tela2, "Senha:", 6, 4)
LbEmail_Tela2.configure(text_color="White", font=("arial", 15, "bold"))
Email_Tela2 = CriarCaixaDeTexto(Tela2, 200, 30, 6, 5, 'Insira sua senha', Modo="Senha")
...
Btn1_Tela2 = CriarBotão(Tela2, "Cadastrar-se", Cadastrar, 11, 0, 100, 30)
Btn1_Tela2.configure(fg_color="Blue", hover_color="Purple")
Btn1_Tela2.grid(columnspan=13)



Btn2_Tela2 = CriarBotão(Tela2, "Voltar", Voltar, 12, 0, 100, 30)
...
Btn_Tela2 = CriarBotão(Tela3, "Voltar", Voltar, 5, 6, 100, 30)
